...
setwd("~/Documents/Research/CodonAnalysis_PhagesAndTheirHost/")
...
# Set working directory
setwd("~/Documents/Research/CodonAnalysis_PhagesAndTheirHost/Sequences/Phages/Helgoland/")
...
# Set working directory
setwd("~/Documents/Research/CodonAnalysis_PhagesAndTheirHost/Sequences/Host/")
...
# Set working directory
setwd("~/Documents/Research/PhageHostPrediction/PostThesis/Data/Phages/info/FromGenBank/")

# Load phage metadata
dt_gb_arc_meta <- read.table(file = "curated_metadata_archaeaphages.csv", header = TRUE, stringsAsFactors = FALSE, sep = ",", na.strings = c(""))
dt_gb_bac_meta <- read.table(file = "curated_metadata_bacteriophages.csv", header = TRUE, stringsAsFactors = FALSE, sep = ",", na.strings = c(""))
...
```{r, results = 'hide'}
# Set working directory
setwd("~/Documents/Research/CodonAnalysis_PhagesAndTheirHost/Sequences/Host/NCBI_data/")
...
```{r, results = 'hide'}
# Set working directory
setwd("~/Documents/Research/CodonAnalysis_PhagesAndTheirHost/Sequences/Phages/NCBIphages/")
